...
result_dir.mkdir(parents=True, exist_ok=True) # Dossier dédié au benchmark

# ----- LOAD MODELS & DATA -----
print("Chargement du Reranker BAAI...")
...
# 1. Précalculer le Reranker (identique pour tous les LLMs)
print("\nÉtape 1/2 : Précalcul des résultats du Reranker (BAAI)...")
...
print("\nÉtape 2/2 : Évaluation LLM (Router & Agent)...")

for model in MODELS_TO_TEST:
    print(f"\n[{model}] Démarrage du test...")
    ...
    # Enregistrement des stats pour ce modèle
    ...
    # Sauvegarde du JSON détaillé spécifique au modèle
...
print(f"\n📁 Résultats globaux sauvegardés dans : {global_benchmark_path.resolve()}")